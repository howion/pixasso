...
var pixasso = {
    ...
    determineColor: function(colors, mode) // RGBA STACK -> RGB
    {
        switch(mode)
        {
            ...
            case this.colorPickMode.JointColor:
                var i, color = [colors[0], colors[1], colors[2]]; // TAKE FIRS PIXEL AS A INIT COLOR
    ...
    {
        // PIXSIZE AND ZOOM CANNOT BE LOWER THAN 1
        ...
        var x, y, cx, cy, ctx = canvas.getContext('2d'), ictx = icanvas.getContext('2d'), dominant;
